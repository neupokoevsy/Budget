...
class AddRecordVC: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    lazy var orderedViewControllers: [UIViewController] = {
        return [self.newVc(viewController: "ExpenseViewController"),
                self.newVc(viewController: "IncomeViewController")]
    } ()
...
//               return orderedViewControllers.last
    ...
    func configurePageControl() {
        ...
        self.pageControl.pageIndicatorTintColor = #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)
